...
<head>
    <meta charset="utf-8">
    <title><?=$carteTitre['nom_cart']?></title>
                        ...
                        <div class="row menu-items3">
                            ...
                            <div class="col-md-10">
                                ...
                                foreach ($data as $menu) :
                                    ...
                                    foreach ($data3 as $mets) :
                                        ...
                                        <div class="menu-item3 col-sm-12 col-xs-12 starter dinner desserts">
                                            ...
                                            <div style="padding-top: 15px" class="menu-wrapper">
                                ...
                                foreach ($data1 as $mets1):
                                    ...
                                    <div class="menu-item3 col-sm-12 col-xs-12 starter dinner desserts">
                                        <img style="height: 60px;width: 60px;" src="<?=$url?>images/menus-et-cartes/<?=$image?>" class="img-responsive" alt="<?=$titred?>" />
                                        <div style="padding-top: 15px" class="menu-wrapper">
                                            <h4 style="text-transform: none"><?=$titred?></h4>
                                            <span class="price"><?=$prix?> &euro;</span>
                                            <div class="dotted-bg"></div>
