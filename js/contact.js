...
$(function() {
    ...
    $("#contactForm").submit(function(e) {
        ...
        messages: {
            ...
            email: "Nous avons besoin de votre adresse email",
            subject: "S\'il vous plaît entrer un sujet",
            tell: "S\'il vous plaît entrez votre numero de tell",
            startDate: "S'il vous plaît entrez la date de reservation !!",
            PartySize: "S'il vous plaît entrez le nombre des invitée !!",
            ResTime: "S'il vous plaît entrez l'heur de reservation !!",
