...
$sql1 = "select * from avis where validation='true' order by id DESC";
      ...
      <div class="modal-dialog modal-dialog-vertical-center" role="document">
        <div class="modal-content bd-0 tx-14">
          <div class="modal-header pd-y-20 pd-x-25">
            <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Mettre l'avis en attente</h6>
          ...
          <div class="modal-body pd-25">
            <h4 class="lh-3 mg-b-20">
              Voulez-vous mettre cet avis en attente?
            </h4>
          </div>
